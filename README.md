...
The node editor example, translated :



![](doc/sc2.png)

Overview example from nuklear is still in progress (lots of components and validation requierd).

## Show me the code

As Immediate GUI mode permit to have a linear view of the gui, with simple functions :
...
### SDL2 pur software backend implementation

as Nuklear support both accelerated and soft rendering (using gfx addon), the first implementation made was the "pur" software one. 

**Nota :** 

- This backend needs SDL dev libs installed on system path, 
- The SDL2_gfx repository also needs to be build and compiled prior to zig build
